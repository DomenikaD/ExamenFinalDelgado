...
a persistence unit "ExamenFinalDelgadoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenFinalDelgado/pom.xml":
...
artifact ("ExamenFinalDelgado.war") is already built. You can build
